...
const SingleBlog = () => {
  return (
    <Layout>
       <div className="bg-gray-100 dark:bg-gray-800 pt-35 py-8 h-screen">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                <div className="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                    <img className="w-full h-full object-cover" src="https://img.freepik.com/free-vector/blogging-fun-content-creation-online-streaming-video-blog-young-girl-making-selfie-social-network-sharing-feedback-self-promotion-strategy_335657-2386.jpg " alt="Product Image"/>
                </div>
            ...
            <div className="md:flex-1 px-4">
                ...
                <div className="flex mb-4">
                    <div className="mr-4">
                        ...
                        <span className="text-gray-600 dark:text-gray-300">Travel</span>
                    </div>
                    <div>
                        <span className="font-bold text-gray-700 dark:text-gray-300">Published At:</span>
                        <span className="text-gray-600 dark:text-gray-300">December 1, 2025</span>
                    </div>
                </div>
